Shader "Xiexe/Toon3/XSToon3_ALFallback"
{
    Properties
    {
        ...
        [ToggleUI]_ALFallback("Fallback Mode", Int) = 0
        _ALFallbackTexture("Fallback Texture", 2D) = "black" {}
        [IntRange]_ALFallbackBPM("BPM", Range(70, 180)) = 128
...
//        }
        Pass
        {
            ...
            #include "XSALFallbackDefines.cginc"
    ...
    Fallback "Diffuse"
    CustomEditor "XSToon3.XSToonALFallbackInspector"
}
